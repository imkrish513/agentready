...
function PythonIcon() {
  return (
    <svg className={styles.fileIcon} width="14" height="14" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function FolderIcon({ open }: { open: boolean }) {
  return (
    <svg className={styles.folderIcon} width="14" height="14" viewBox="0 0 16 16" fill="currentColor">
      {open ? (
...
function LockIcon() {
  return (
    <svg className={styles.lockIcon} width="12" height="12" viewBox="0 0 16 16" fill="currentColor">
